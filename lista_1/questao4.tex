...
\begin{flalign*}
G'_{ff}(s) & = \frac{G_d(s)}{\underbrace{G_c(s)}_{\text{equação
...
\begin{flalign*}
G_{ff}(s) & = \frac{1 + G'(s)G'_c(s)}{G'(s)G'_c(s)}\cancel{e^{s}} - 1 =
\frac{1}{\underbrace{G'(s)}_{\text{equação
\ref{eq:q4:glinha}}}\underbrace{G'_c(s)}_{\text{equação \ref{eq:q4:glinha_c}}}}
...
\begin{flalign}
F_1(s) & = \frac{1}{s+1} \nonumber \\
G_{ff1} & = G_{ff}(s)F_1(s)F_1(s) = \frac{1}{2}\frac{s^2 + 0.25s}{s +
0.2}\frac{1}{s+1}\frac{1}{s+1} = 0.5\frac{0.25s+s^{2}}{0.2+1.4s+2.2s^{2}+s^{3}}
\label{eq:q4:g_ff1}
\\
F_{10}(s) & = \frac{10}{s+10} \nonumber \\
G_{ff10} & = G_{ff}(s)F_{10}(s)F_{10}(s) = \frac{1}{2}\frac{s^2 + 0.25s}{s +
0.2}\frac{10}{s+10}\frac{10}{s+10} = 50\frac{s^{2}+0.25s}{s^{3}+20.2s^{2}+104s+20}
\label{eq:q4:g_ff10}
\end{flalign}
