...
% Questão 1
% - O sistema em MA é instável, o diagrama de Bode irá fazer a verificação da
%   malha fechada
% - Comentar que o pico do Bode de MF ocorre na frequência característica Wn = 3
% - Acho que somente precisava o diagrama de bode para o sistema de malha
%   fechada e é nele que devemos indicar a margem de ganho e de fase
